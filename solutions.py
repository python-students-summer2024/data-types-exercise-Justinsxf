...
def calculate_profit():
    ...
    """
    total_sales = float(input("enter your annual profit?"))
...
def calculate_miles_per_gallon():
    ...
    """
    Miles_driven = int(input("enter your miles driven"))
    Gas_used = int(input("enter your gas used"))
...
def align_text():
    ...
    The print out the price values so that they are formatted to two decimal places. Also make sure that the price 
    values are right aligned and line up at the decimal point.
    ...
    print("\nHere are your prices!\n")
    print(f"Price #1: ${num1:10.2f}")
    print(f"Price #2: ${num2:10.2f}")
    print(f"Price #3: ${num3:10.2f}")